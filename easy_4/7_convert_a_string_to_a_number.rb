...
# behave similarly. In this exercise, you will create a method that does the same
# thing.
#
...
# this the old-fashioned way and calculate the result by analyzing the characters in
# the string.
